...
class SysTray(object):
    ...
    def __init__(self, icon, hover_text, menu_options,
            on_quit=None, default_menu_index=None,
        ...
        self.window_class_name = window_class_name or "SysTray"
        message_map = {
        ...
        self.hwnd = win32gui.CreateWindow(classAtom,
                self.window_class_name, style, 0, 0,
    ...
    def _add_ids_to_menu_options(self, menu_options):
        ...
        for menu_option in menu_options:
            ...
            if callable(option_action) or option_action in self.SPECIAL_ACTIONS:
                ...
                result.append((option_text, option_action,
    ...
    def prep_menu_icon(self, icon):
        ...
        win32gui.DrawIconEx(hdcBitmap, 0, 0, hicon,
                ico_x, ico_y, 0, 0, win32con.DI_NORMAL)
...
if __name__ == "__main__":
    ...
    menu_options = (
            ...
            ('A Submenu', icons.next(), (
                ('Say Hello to Simon', icons.next(), kates),
                ('Switch Icon', icons.next(), switch_icon),)))

    def bye(sysTrayIcon):
        print "Bye, then"

    SysTray(icons.next(), hover_text, menu_options,
