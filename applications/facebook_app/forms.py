...
from flaskext.wtf import (
        Form, Required, TextField, BooleanField,
        SelectField, CheckboxInput, SelectMultipleField,
        RadioField, widgets)

class SettingsForm(Form):
    events = BooleanField("Events", default=True)
    friends = BooleanField("Friends", default=True)
    notes = BooleanField("Notes", default=True)
